...
class Plugin {
	 ...
	 */
	public function __construct( Setup $setup, Frontend $frontend, Shortcodes $shortcodes, Classic_Editor $classic_editor, Media_Library $library, Settings_Page $media_settings ) {
