...
/**
 * Media_Credit\Data_Storage\Options unit test.
 *
 * @since 4.2.0
 *
 * @coversDefaultClass \Media_Credit\Data_Storage\Options
 * @usesDefaultClass \Media_Credit\Data_Storage\Options
 */
class Options_Test extends TestCase {
	...
	public function test_constructor() {
		...
		//Functions\expect( 'wp_cache_get' )->once()->with( m::type( 'string' ), Options::GROUP )->andReturn( 42 );

		$cache->__construct();

		$this->assert_attribute_same( Options::PREFIX, 'prefix', $cache );
	}
}
