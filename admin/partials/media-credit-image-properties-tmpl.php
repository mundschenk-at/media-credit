...
?><script type="text/html" id="tmpl-media-credit-image-properties">
	<div class="image-settings-group media-credit-properties">
		<label class="setting media-credit-text">
			...
			<input id="attachments[shortcode][media-credit-hidden]" type="hidden" data-setting="mediaCreditID" data-post-id="shortcode" data-author="{{ data.mediaCreditID }}" data-author-display="{{ data.mediaCreditName }}" data-nonce="<?php echo esc_attr( wp_create_nonce( 'media_credit_author_names' ) ); ?>" class="media-credit-hidden" value="{{ data.mediaCreditID }}" />
		</label>
