...
const MEDIA_CREDIT_WORDPRESS_FUNCTIONS = [
    // Transients.
    'get_transient',
    'set_transient',
    'delete_transient',
...
return [
    ...
    'finders' => [
        ...
        Finder::create()
            ->files()
            ->ignoreVCS(true)
            ->notName( '/' . MEDIA_CREDIT_EXCLUDED_FILES . '/' )
            ->exclude( [
                'Extra',
                'Loader',
                'tests',
        ...
        Finder::create()
            ...
            ->ignoreVCS(true)
            ->notName( '/' . MEDIA_CREDIT_EXCLUDED_FILES . '/' )
            ->exclude( MEDIA_CREDIT_EXCLUDED_DIRS )
    ...
    'patchers' => [
        function (string $file_path, string $prefix, string $contents): string {
            ...
            if (
                ...
                $functions = \join( '|', MEDIA_CREDIT_WORDPRESS_FUNCTIONS );
